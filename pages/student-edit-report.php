...
<body class="nav-md" style="background:none;">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel" style="box-shadow: 0 3px 10px rgb(0 0 0 / 50%);">
                            ...
                            <div class="x_content">
                                ...
                                ?>
                                <form method="POST" role="form" id="update-report" class="form-horizontal form-label-left" enctype="multipart/form-data">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        $userTasks = json_decode($userReport->task);
                                        foreach ($tasks as $task) {
                                        ?>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="<?= $task ?>" name="task[]" <?php echo in_array($task, $userTasks) ? "checked" : "" ?>>
    ...
    <script>
        $("#update-report").on("submit", function(e) {
            swal.showLoading();
            $.ajax({
                url: '../actions/update-report.php',
                ...
                success: function(data) {
                    ...
                    if (data.success) {
                        swal.fire({
                            ...
                            window.location.href = 'student-reports.php'
                        })
                    } else {
                        swal.fire({
                            title: 'Error!',
