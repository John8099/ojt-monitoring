...
<body class="nav-md" style="background:none;">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel" style="box-shadow: 0 3px 10px rgb(0 0 0 / 50%);">
                            ...
                            <div class="x_content">
                                <form method="POST" role="form" id="update-supervisor" class="form-horizontal form-label-left">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input value="<?php echo $user->company ?>" type="text" name="company" class="form-control col-md-7 col-xs-12" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input value="<?php echo $user->position ?>" type="text" name="position" class="form-control col-md-7 col-xs-12" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input value="<?php echo $user->contact ?>" type="text" name="cnum" class="form-control col-md-7 col-xs-12" required>
                                        </div>
                                    </div>
    ...
    <script>
        $("#update-supervisor").on("submit", function(e) {
            swal.showLoading();
            $.ajax({
                url: '../actions/update-supervisor.php',
                data: $(this).serialize(),
                type: 'POST',
