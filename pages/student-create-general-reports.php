...
<body class="nav-md" style="background:none;">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel" style="box-shadow: 0 3px 10px rgb(0 0 0 / 50%)">
                            <div class="x_title">
                                <h2>Upload General Report</h2>
                                <div class="clearfix"></div>
                            </div>
                            <div class="x_content">
                                <form method="POST" role="form" id="create-gen-report" class="form-horizontal form-label-left" enctype="multipart/form-data">
    ...
    <script>
        $("#create-gen-report").on("submit", function(e) {
            swal.showLoading();
            ...
            if (!fileData) {
                ...
                $.ajax({
                    url: '../actions/create-gen-report.php',
